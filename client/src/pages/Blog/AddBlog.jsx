...
export default function AddBlog() {
  ...
  async function onSubmit(values) {
    try {
      if (!file) {
        return showToast("error", "Please Add a Feature Image to Post Blog");
      }
      setPageLoading(true);
              ...
              <div className="mb-4 p-2">
                ...
                <Dropzone onDrop={(acceptedFiles) => handleFile(acceptedFiles)}>
                  {({ getRootProps, getInputProps }) => (
                    <div {...getRootProps()}>
                      <input {...getInputProps()} />
                      <div className="flex justify-center items-center w-36 h-28 border-2 border-dashed p-3 rounded-2xl">
